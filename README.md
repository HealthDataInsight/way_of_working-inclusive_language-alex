...
This project uses [mise](https://mise.jdx.dev/) to manage Ruby and Node versions. After installing mise, run `bin/setup` to install dependencies. Then, run `rake test` to run the tests. You can also run `bin/console` for an interactive prompt that will allow you to experiment.
